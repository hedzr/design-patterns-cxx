...
if (DEFINED PROJECT_MACRO_PREFIX)
    ...
    set(PROJECT_MACRO_PREFIX ${CMAKE_PROJECT_NAME})
endif ()

if (DEFINED VERSION_H_NAME)
else ()
    set(VERSION_H_NAME "${CMAKE_PROJECT_NAME}-version.hh")
endif ()
...
if (EXISTS ${xCONFIG_BASE_IN})
    ...
    configure_file(
            ${xCONFIG_BASE_IN}
            ${CMAKE_GENERATED_DIR}/${CMAKE_PROJECT_NAME}-config.hh
    )
    message(STATUS "Generated: ${CMAKE_GENERATED_DIR}/${CMAKE_PROJECT_NAME}-config.hh")
endif ()
