...
namespace dp::traits {
     ...
     * };
     * const int c3 = dp::traits::member_args_count(&s::m).value;
     */
...
namespace std {
    template<int I>
    struct is_placeholder<dp::traits::placeholder<I>> : std::integral_constant<int, I> {};
} // namespace std
...
#define DP_SINGLETON(t) dp::util::singleton<t>
...
namespace dp::util {
     ...
     *     
     *     // with a lambda
     *     hicc::util::defer&lt;bool&gt; fn_closer([]{
     *         // ... your closer here
     *     });
     * @endcode
     ...
     * @details For example:
     * @code{c++}
     *     hicc::util::defer&lt;bool&gtl fn_closer([]{
     *         // ... your closer here
     *     });
     * @endcode
     */
