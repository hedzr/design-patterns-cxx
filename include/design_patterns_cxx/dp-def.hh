...
#ifndef DP_ASSERT
#if defined(DP_CXX_ENABLE_ASSERTIONS) && defined(_DEBUG)
#define DP_ASSERT(...) assert(__VA_ARGS__)
#else
#define DP_ASSERT(...) UNUSED(__VA_ARGS__)
#endif
#endif
...
#if defined(DP_CXX_ENABLE_ASSERTIONS)
...
#if defined(__GNUC__)
#define DP_EXPORT __attribute__((__visibility__("default")))
#else
#define DP_EXPORT
#endif
#if defined(__has_feature)
#define DP_HAS_FEATURE(...) __has_feature(__VA_ARGS__)
#else
#define DP_HAS_FEATURE(...) 0
#endif
#if DP_HAS_FEATURE(thread_sanitizer) || __SANITIZE_THREAD__
#ifndef DP_SANITIZE_THREAD
#define DP_SANITIZE_THREAD 1
#endif
#endif
...
// }
//
// template<class T, class = decltype(dp::detail::check<T>())>
...
namespace detail {
    template<class Container,
             std::enable_if_t<
                     dp::traits::is_iterable<Container>::value &&
...
namespace detail {
    template<class TX,
             ...
             std::enable_if_t<dp::traits::is_iterable<Container<TX>>::value &&
