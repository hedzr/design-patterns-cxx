...
#ifndef DP_CXX_HZ_X_TEST_HH
#define DP_CXX_HZ_X_TEST_HH

#if defined(DP_CXX_UNIT_TEST) && DP_CXX_UNIT_TEST == 1
...
namespace dp::test {
     ...
     * @tparam _Args 
     * @see DP_TEST_FOR
     * @note To use wrapper class, see also DP_TEST_FOR(func) macro.
     * In your test app, it'll be quoted as:
     * @code{c++}
     * void test_func_1(){ ... }
     * int main(){
     *   DP_TEST_FOR(test_func_1);
     * }
     * @endcode
     */
    ...
    /**
     * @brief DP_TEST_FOR will wrap a test function to add pre-/post-process on it.
     ...
     * @endcode
     */
#define DP_TEST_FOR(f) dp::test::bind(#f, f)
